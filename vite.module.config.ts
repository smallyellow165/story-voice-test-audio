...
export default defineConfig({
  ...
  build: {
    outDir: 'dist-module',
    lib: { entry: { index: 'src/ring-feet-module.tsx', 'touch-color': 'src/touch-color-module.ts', 'simon-says': 'src/simon-says-module.ts' }, formats: ['es'], fileName: (_format, name) => `${name}.js` },
  },
})
