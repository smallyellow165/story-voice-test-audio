...
export default defineConfig({
  ...
  build: { rollupOptions: { input: { main: 'index.html', storybookMarker: 'storybook-marker.html', hopscotch: 'hopscotch.html', touchColor: 'touch-color.html', ringFeet: 'ring-feet.html', ringLlm: 'ring-llm.html', geminiBaseline: 'gemini-baseline.html', geminiOfficial: 'gemini-official.html', layoutBaseline: 'layout-baseline.html' } } },
})
